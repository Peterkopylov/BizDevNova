...
const DECK_ID = "ai-roleplay-market-summary";
const OUT_DIR = "/Users/peter.kopylov/Documents/BizDev/research/presentations/ai-roleplay-market-summary";
const REF_DIR = "/Users/peter.kopylov/Documents/BizDev/research/presentations/ai-roleplay-market-summary/ref";
...
const SOURCES = {
  market: "Workspace note: 2026-04-22-ai-for-simulating-real-life-conversations-and-scenarios-primary-research.md",
  businessCase: "Workspace note: 2026-05-18-most-viable-business-case-for-ai-roleplay-market-entry.md",
  features: "Workspace note: 2026-05-18-critical-features-to-enter-ai-roleplay-market.md",
  yoodli: "Workspace note: 2026-04-22-yoodli-competitor-note.md",
  secondNature: "Workspace note: 2026-04-22-second-nature-competitor-note.md",
  skillsoft: "Workspace note: 2026-04-22-skillsoft-caisy-competitor-note.md",
  simmie: "Workspace note: 2026-04-22-simmie-competitor-note.md",
  virti: "Workspace note: 2026-04-22-virti-competitor-note.md",
  mursion: "Workspace note: 2026-04-22-mursion-competitor-note.md",
  dialoguetrainer: "Workspace note: 2026-04-22-dialoguetrainer-competitor-note.md",
  multiNpc: "Workspace note: 2026-05-18-multi-npc-business-cases-and-best-wedge.md",
};

const SLIDES = [
  {
    "kicker": "TEAM SUMMARY",
    "title": "AI Roleplay Market Summary",
    "subtitle": "Category structure, key competitors, funding posture, table-stakes features, and our best entry wedge.",
    "expectedVisual": "Clean editorial cover with strong title hierarchy and one bottom-line takeaway card.",
    "moment": "AI chat is not the product. Rehearsal infrastructure is.",
    "notes": "Open with the category reframing: the market is real, but the strongest products win on practice, scoring, and readiness, not on generic conversational novelty.",
    "sources": [
      "market",
      "businessCase"
    ]
  ...
  {
    "kicker": "MARKET",
    "title": "The category is real, but it is not one market",
    "subtitle": "Competitors cluster around training and readiness. The category is moving from AI chat toward structured rehearsal.",
    "expectedVisual": "Three-card market summary with clean contrast and editorial spacing.",
    "cards": [
      [
        "MARKET SHAPE",
        "Five visible wedges: enterprise training, revenue roleplay, interview rehearsal, education, and emerging group simulation."
      ],
      [
        "COMMERCIAL CENTER",
        "The strongest demand today sits in training and enablement, where buyers already own readiness, ramp, and coaching budgets."
      ],
      [
        "STRATEGIC SHIFT",
        "Winners are selling practice, scoring, and visibility, not generic conversation quality by itself."
      ]
    ],
    "notes": "This slide sets the market frame. Emphasize that customers buy outcomes after conversations, not the novelty of an AI conversation itself.",
    "sources": [
      "market"
    ]
  },
  {
    "kicker": "COMPETITORS",
    "title": "Key competitors cluster into a few practical groups",
    "subtitle": "Different companies win through different GTM motions, but the strongest cluster is around revenue and workforce readiness.",
    "expectedVisual": "Three cards describing competitor clusters and the strategic direction of the market.",
    "cards": [
      [
        "ENTERPRISE L&D",
        "Skillsoft CAISY, DialogueTrainer, Virti, and Mursion package simulation as workforce training and measurable skill development."
      ],
      [
        "REVENUE ENABLEMENT",
        "Second Nature, Simmie, Yoodli, and RoleLab focus on sales readiness, onboarding, objection handling, and certification."
      ],
      [
        "WHERE IT IS HEADING",
        "Yoodli and Second Nature already hint at multi-stakeholder scenarios; Google DialogLab signals the future of group simulation."
      ]
    ],
    "notes": "This is the slide to orient the team on who matters now and why. The practical center of gravity is still one-on-one training, with multi-party simulation emerging as the future wedge.",
    "sources": [
      "skillsoft",
      "dialoguetrainer",
      "virti",
  ...
  {
    "kicker": "FUNDING",
    "title": "Funding signals show a category with both incumbents and room for entrants",
    "subtitle": "The market ranges from public-company distribution to well-funded startups to early-stage specialists.",
    "expectedVisual": "Three funding-stage cards that make market maturity legible at a glance.",
    "cards": [
      [
        "INCUMBENTS",
        "Skillsoft is public (NYSE: SKIL). Virti and Mursion show longer-running venture-backed platform plays in training."
      ],
      [
        "SCALE-UP SIGNAL",
        "Yoodli stands out with a reported $40M Series B and valuation above $300M, proving strong investor belief in the category."
      ],
      [
        "OPEN SPACE",
        "Second Nature funding visibility is partial and Simmie is still early-stage, which suggests room for focused entrants."
      ]
    ],
    "notes": "The point here is not precise cap-table analysis. It is that the market is validated enough to matter, but still open enough that a focused wedge can win.",
    "sources": [
      "skillsoft",
      "virti",
      "mursion",
  ...
  {
    "kicker": "VALUE PROPS",
    "title": "Customers buy readiness, not AI chat",
    "subtitle": "The strongest value propositions repeat across competitors and explain why teams actually pay for these products.",
    "expectedVisual": "Three cards summarizing the value propositions customers consistently respond to.",
    "cards": [
      [
        "PRACTICE AT SCALE",
        "Replace inconsistent mock sessions with repeatable reps that do not consume more manager or trainer time."
      ],
      [
        "READINESS AND PROOF",
        "Buyers want scores, certification, and evidence that someone is ready before they go live with customers or employees."
      ],
      [
        "COMPANY-SPECIFIC REALISM",
        "Playbooks, call transcripts, and custom personas make simulations feel operational instead of generic."
      ]
    ],
    "notes": "This is the key reframing slide. If the team remembers one thing, it should be that the paid value is operationalized rehearsal, not just a better chatbot.",
    "sources": [
      "market",
      "secondNature",
      "simmie",
  ...
  {
    "kicker": "FEATURES",
    "title": "Table stakes are now clear",
    "subtitle": "We do not need every feature in the market, but we do need the core stack that makes roleplay operationally credible.",
    "expectedVisual": "Three cards covering the minimum credible product stack.",
    "cards": [
      [
        "CORE LOOP",
        "Scenario builder, persona builder, and live voice or voice plus text simulation are the minimum believable practice loop."
      ],
      [
        "MEASUREMENT",
        "Rubric scoring, feedback, transcript or replay, and repeat attempts turn practice into measurable improvement."
      ],
      [
        "TEAM INFRASTRUCTURE",
        "Manager dashboard, assignment, certification, and integrations make the product deployable inside real programs."
      ]
    ],
    "notes": "This is the practical build slide. It should help the team separate table stakes from later differentiation.",
    "sources": [
      "features"
    ]
  },
  {
    "kicker": "OUR WEDGE",
    "title": "Our best entry point is focused readiness first, social complexity second",
    "subtitle": "Enter where ROI is clearest, then differentiate where one-on-one roleplay starts to break down.",
    "expectedVisual": "Three strategic cards: first wedge, future wedge, and thesis.",
    "cards": [
      [
        "FIRST WEDGE",
        "Start with sales and customer-facing onboarding, objection handling, and certification. The ROI story is clearest there."
      ],
      [
        "FUTURE WEDGE",
        "Use multi-NPC scenarios as the premium differentiator: buying committees, panel interviews, and multi-stakeholder conversations."
      ],
      [
        "PRODUCT THESIS",
        "Enter with readiness infrastructure. Win later with orchestration, group dynamics, and room-level coaching."
      ]
    ],
    "notes": "Close with the strategy call: we should not lead with the hardest simulation problem, but we should build toward the wedge that gives us real separation later.",
    "sources": [
      "businessCase",
      "features",
      "multiNpc"
...
async function slideCards(presentation, idx) {
  ...
  for (let cardIdx = 0; cardIdx < cols; cardIdx += 1) {
    ...
    addCard(slide, idx, x, 362, cardW, 228, label, body, { iconKind: iconKinds[cardIdx % iconKinds.length] });
  }
